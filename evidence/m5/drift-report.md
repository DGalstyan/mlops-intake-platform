...
- Window: `deliberately shifted batch` — 400 documents, 0 reviewed, 0 overridden
- Baseline snapshot: `sha256:0aba339dd3d872afd4295cb32d150f5e37d3d173259530c28f57f0cc93a5500d`
- Generated: 2026-07-30T15:08:06+00:00
- Triggers retrain: **no**
...
| `override_rate_trend` | 0.0000 | 0.5 | no | override rate is 0.0% of 0 reviewed documents, but the baseline records no override-rate reference (it was built from training data, where nothing was reviewed). This becomes a usable signal once a production window has been captured as the new reference. |
